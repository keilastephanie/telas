            ...
            <div class="col-sm-12 ">
                        ...
                        <div class="bg-secondary rounded h-50 p-4">
                            ...
                            <div class="container">
                                <div class="row">
                                <div class="col-sm-12">
                              <form method="post"id="frmAdocao">
                                <div class="row">
                                    <div class="col-sm-2">
                                        <label for="text" >ID Adoção</label>
                               ...
                               <button class="btn btn-light mt-4" id="btoPesquisar"> Pesquisar</button>
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="date" class="form-control" name="txtDataCadastro" id="txtDataCadastro">
                                </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-8">
                                         <label for="text" >Nome</label> 
                                          <input type="text" class="form-control" name="txtNomeAdocao" id="txtNomeAdocao">
                                    </div>
                                    <div class="col-sm-4">
                                         <label for="text" >Nome do Animal</label> 
                                          <input type="text" class="form-control" name="txtNomeAnimal" id="txtNomeAnimal">
                                    </div>
                                    </div>
                                       <div class="row">
                                        <div class="col-sm-2">
                                        <label for="text">Sexo Animal</label> 
                                         <input type="text" class="form-control" name="txtSexoAnimal" id="txtSexoAnimal">
                                       </div>
                                       <div class="col-sm-2">
                                       <label for="txtRacaAnimal" class="form-label">Raça do Animal</label><br>
							<input type="text" id="txtRacaAnimal" name="txtRacaAnimal" class="form-control">
                                      
                                       </div>
                                       <div class="col-sm-2">
                                        <label for="" >Porte</label>
                                        <input type="text" class="form-control"name="txtPorteAnimal" id="txtPorteAnimal">
