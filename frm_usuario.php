            ...
            <div class="col-sm-12">
                        ...
                        <div class="bg-secondary rounded h-50 p-4">
                            <h6 class="mb-4">Formulario Usuario</h6>
						      <div class="container">
                                <div class="col-sm-12">
                                    <form action="" class="secondary" method="post"  id="frmUsuario">
                                <div class="row">
                                    <div class="col-sm-2">
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                          <label for="text">Login</label>
                                           <input type="login" class="form-control" name="txtLogin" id="txtLogin">
                                    </div>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                              <label for="number" >Data de Cadastro</label>
...
$(document).ready(function() {
    ...
    function limpar_frmUsuario_cep() {
